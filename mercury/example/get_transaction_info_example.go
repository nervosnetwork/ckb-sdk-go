...
func TestGetTransaction(t *testing.T) {
	transaction, err := constant.GetMercuryApiInstance().GetTransactionInfo(
		types.HexToHash("0x83b849ef0c2fc02eab20faad0357026d0f94b98444a4fe947a11bcbafa01b4e8"))
	if err != nil {
		t.Error(err)
	}
...
func TestGetCellBaseTransactions(t *testing.T) {
	transaction, err := constant.GetMercuryApiInstance().GetTransactionInfo(
		types.HexToHash("0x9d3aff02b84c0d624d9eed265997d83c067cde554e9c4128806517fccc523e2f"))
	if err != nil {
		t.Error(err)
	}
...
func TestGetDaoTransactions(t *testing.T) {
	transaction, err := constant.GetMercuryApiInstance().GetTransactionInfo(
		types.HexToHash("0x94f30978b3d23b6d94dc559e8dc3e1b7a185712be26bba42f31543a08470035e"))
	if err != nil {
		t.Error(err)
	}
