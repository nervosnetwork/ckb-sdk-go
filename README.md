...
4. [`get_mercury_info` example](./mercury/example/get_mercury_info_example.go)
5. [`get_db_info` example](./mercury/example/get_db_info_example.go)
6. [`register_addresses` example](./mercury/example/register_addresses_example.go)
7. [`adjust_account_transaction` example](./mercury/example/build_adjust_account_transaction_example.go)
8. [`build_transfer_transaction` example](./mercury/example/transfer_completion_example.go)
9. [`build_transfer_transaction` by action example](./mercury/example/action_example.go)
10. [`build_transfer_transaction` by source example](./mercury/example/source_example.go)
11. [`build_transfer_transaction` by normal address example 1](./mercury/example/normal/acp_example.go)
12. [`build_transfer_transaction` by normal address example 2](./mercury/example/normal/cheque_example.go)
13. [`build_transfer_transaction` by normal address example 3](./mercury/example/normal/secp256k1_example.go)
14. [`build_smart_transaction` example](./mercury/example/build_smart_transfer_transaction_example.go)
15. [`build_adjust_account_transaction` example](./mercury/example/build_adjust_account_transaction_example.go)
16. [`get_spent_transaction` example](./mercury/example/get_spent_transaction_example.go)
17. [`query_transactions` example](./mercury/example/query_transactions_example.go)
